...
CREATE USER IF NOT EXISTS 'services_dev' @'localhost' IDENTIFIED BY 'eservices_pwd';

GRANT ALL PRIVILEGES ON `eservices_dev_db`.* TO 'services_dev' @'localhost';

GRANT SELECT ON `performance_schema`.* TO 'services_dev' @'localhost';
